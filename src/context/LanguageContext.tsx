...
const translations = {
  fr: {
    ...
    "history.2025.title": "Victoire Épique",
    "history.2025.desc": "Victoire mémorable 8-6 contre ATLAS LEGEND, affirmant notre domination régionale.",
  ...
  ar: {
    ...
    "history.2025.title": "انتصار ملحمي",
    "history.2025.desc": "فوز تاريخي 8-6 على ATLAS LEGEND، مؤكدين سيطرتنا الإقليمية.",
