...
const translations = {
  fr: {
    ...
    "history.2024.title": "La Fondation",
    "history.2024.desc": "Mars 2024 : Naissance officielle de la section Esports du prestigieux Kawkab Athlétique Club de Marrakech.",
    "history.2025.title": "L'Équipe Légendaire",
    "history.2025.desc": "Mars 2025 : Participation au tournoi MTN ESPORTS RAMADAN 2025. C'est à ce moment précis que l'équipe légendaire KACM Esports s'est officiellement formée.",
    "history.2026.title": "Victoire Épique",
    "history.2026.desc": "08 Mars 2026 : Victoire mémorable 8-6 contre ATLAS LEGEND, affirmant notre domination régionale.",
    "history.2026_2.title": "Le Choc des Titans",
    "history.2026_2.desc": "Malgré la défaite, les joueurs ont montré tout leur potentiel contre la même squad Atlas legend.",
  ...
  ar: {
    ...
    "history.2024.title": "التأسيس",
    "history.2024.desc": "مارس 2024: ولادة فرع الرياضات الإلكترونية لنادي الكوكب الرياضي المراكشي العريق.",
    "history.2025.title": "الفريق الأسطوري",
    "history.2025.desc": "مارس 2025: المشاركة في بطولة MTN ESPORTS RAMADAN 2025. في هذه اللحظة بالذات، تشكل فريق الكوكب المراكشي الأسطوري رسميًا.",
    "history.2026.title": "انتصار ملحمي",
    "history.2026.desc": "08 مارس 2026: فوز تاريخي 8-6 على ATLAS LEGEND، مؤكدين سيطرتنا الإقليمية.",
    "history.2026_2.title": "صراع العمالقة",
    "history.2026_2.desc": "على الرغم من الهزيمة، أظهر اللاعبون كل إمكانياتهم ضد نفس فريق Atlas legend.",
